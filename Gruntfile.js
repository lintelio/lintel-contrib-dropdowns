...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      ...
      dist: {
        files: {
          '<%= lintel.dist %>/dropdowns.css': 'sass/lintel-core-loader.scss'
        }
      }
    },
    ...
    cssmin: {
      ...
      dist: {
        src: '<%= lintel.dist %>/dropdowns.css',
        dest: '<%= lintel.dist %>/dropdowns.min.css'
      }
    },
    ...
    webshot: {
      xs: {
        options: {
          siteType: 'url',
          site: 'http://localhost:4554/dropdowns.html',
    ...
    notify: {
      sass: {
        options: {
          title: 'lintel-contrib-dropdowns',
